...
@Table(name = "tge_quality_check")
@ApiModel(value = "TgeQualityCheck", description = "")
public class TgeQualityCheck implements Serializable{
private static final long serialVersionUID=1L;
    ...
    @ApiModelProperty("effectiveTime")
        @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss",timezone="GMT+8")
