...
@Table(name = "grid_basic_info_history")
@ApiModel(value = "GridBasicInfoHistory", description = "网格基础信息历史表-变化前快照")
public class GridBasicInfoHistory implements Serializable{
private static final long serialVersionUID=1L;

    @Id
    @KeySql(genId = com.hypersmart.base.id.genId.Suid.class)
    @Column(name = "id")
    @ApiModelProperty("网格历史主键")
    private String id;

    @Column(name = "grid_id")
    @ApiModelProperty("网格主键ID")
